...
- UMG starter themes now ship: three production themes — Horror (*Pale Static*), Visual Novel (*Daybreak*), and RPG (*Gilded Slate*) — under `/MayDialogue/Themes`. The canonical showcase applies and live-switches them through `AMayDialogueThemeSetter`. See [Themes & Starter Kits](../ui/themes.md).
