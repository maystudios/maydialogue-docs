...
> *Setup:* Plugins window open, "Gameplay" category selected. MayDialogue entry visible with an enabled checkbox and the plugin description text. Red arrow pointing at the enabled checkbox.
