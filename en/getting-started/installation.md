...
**Plugin dependencies** (enabled automatically — you don't need to activate them manually):
...
2. Navigate to the `Plugins/` folder in your project directory. If the folder does not exist, create it.
...
MayDialogue ships a content directory with default assets. To make the Content Browser display it:
...
If you see this editor, installation is complete.
