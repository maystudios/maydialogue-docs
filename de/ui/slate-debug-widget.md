...
{% hint style="warning" %}
**Level-Travel:** Das Slate-Widget bindet sich nach einem Level-Wechsel nicht automatisch neu. Rufe vor dem Travel `Subsystem->AbortAllDialogues()` auf oder entferne das Widget manuell vom Viewport. Im Blueprint steht dafür der Node `Abort All Dialogues` auf dem MayDialogue-Subsystem bereit.
{% endhint %}
